...
class RectOutlineBuffer {
    ...
    private fun ensureInitialized() {
        ...
        // @formatter:off
        /* ktlint-disable no-multi-spaces *//* ktlint-disable indent */
        val attributeValues = floatArrayOf(
            ...
            -o, o, -o, 1.0f, 1f, 0f, 0f, 0f,// 20
            -o, o, -o, 0.0f, 1f, 0f, 0f, 0f// 21 (1)
        )/* ktlint-disable indent *//* ktlint-disable no-multi-spaces */
        // @formatter:on
        ...
        glBufferData(
            GLES20.GL_ARRAY_BUFFER, attributeValues.size * Util.FLOAT_SIZE, attributesBuffer, GLES20.GL_STATIC_DRAW
        )
